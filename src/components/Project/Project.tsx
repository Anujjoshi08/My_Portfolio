        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Anujjoshi08/News-App"
                  target="_blank"
                  rel="noreferrer"
                >
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://news-app-git-main-anuj-joshis-projects-bf06f519.vercel.app" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> 
              </div>
            </header>
            <div className="body">
              ...
              <p>
                {" "}
                I built a responsive News Website using HTML, CSS, and
                JavaScript. The site fetches and displays news dynamically with
                clean categories and smooth navigation. UI is simple, fast, and
                optimized for a good reading experience on all devices.{" "}
              </p>
            </div>
            <footer>
              {" "}
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              <h3>Portfolio</h3>
              <p>
                This portfolio is designed with React and Tailwind, following a
                minimal and aesthetic layout. It includes interactive project
                cards, a simple navigation flow, and mobile-first
                responsiveness. Every section is structured to reflect my work
